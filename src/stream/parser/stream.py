...
stream.py
Stream Structure Object File for Parsing

Mention @Diggie-Bro/froglang for any help!
"""
from . import keywords
from . import string_obfuscation as strobfus
    ...
    def makeStructure(self):
        ...
        for index, code in enumerate(codes):
            ...
            for i, char in enumerate(list(code)):
                if char == '{':
                    if braceRangeIndex is None:
                        braceRangeIndex = i
                elif char == '}':
                    # suppose grammar is right.
                    if braceRangeIndex is not None:
            ...
            for i, char in enumerate(list(code)):
                if char == '"':
                    if stringRangeIndex is not None:
